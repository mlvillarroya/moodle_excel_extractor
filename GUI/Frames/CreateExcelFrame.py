...
from GUI.Methods.OpenFolder import open_folder
...
def create_excel_frame(create_excel_tab):
    ...
    first_tab_left_frame_option_4 = tk.Checkbutton(first_tab_left_frame_subframe_2, text="One answer 4")
    ...
    first_tab_center_frame_button = ttk.Button(first_tab_center_frame_subframe_2, text="Browse", command= lambda: open_folder(first_tab_center_frame_text_block))
